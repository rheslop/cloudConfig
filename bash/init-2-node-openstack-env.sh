...
# Controller (12G memory, 2 vcpus, 160 GiB HDD)
#

for i in 1; do
qemu-img create -f qcow2 /var/lib/libvirt/images/controller-${i}.qcow2 160G
...
# Compute (32G memory, 2 vcpus, 120 GiB HDD)
#
...
for i in 1; do
  ...
  if [ ${COMPUTES_ON_EXTERNAL} == "yes" ]; then
    ...
    qemu-img create -f qcow2 /var/lib/libvirt/images/compute-${i}.qcow2 240G
